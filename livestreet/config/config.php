 ...
 * Настройки HTML вида
 */
$config['view']['skin']        = 'ls-theme_street-spirit-master';                                                              // шаблон(скин)
$config['view']['name']        = 'PRIDE time';                   // название сайта
...
$config['sys']['cache']['use']    = false;               // использовать кеширование или нет #TODO: turn on cache
