<?php /* Smarty version Smarty-3.1.8, created on 2015-09-14 15:03:14
         compiled from "/srv/www/livestreet/templates/skin/ls-theme_street-spirit-master/window_login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:83951862755f6b782defa04-36274120%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9702f2d67ae46973b744d7a3d7c7a46dc1ed7448' => 
    array (
      0 => '/srv/www/livestreet/templates/skin/ls-theme_street-spirit-master/window_login.tpl',
      1 => 1441978720,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '83951862755f6b782defa04-36274120',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55f6b782e4b401_41915162',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55f6b782e4b401_41915162')) {function content_55f6b782e4b401_41915162($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/srv/www/livestreet/engine/modules/viewer/plugs/function.router.php';
...
" class="input-text input-width-300" style="width: 322px"></p>
...
" id="popup-registration-user-password-confirm" value="" class="input-text input-width-300 js-ajax-validate" />
					...
					<p><div class="clear"><label for="popup-registration-captcha"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['registration_captcha'];?>
</label></div>
...
" id="popup-reminder-mail" class="input-text input-width-300" />
					...
					<p><button type="submit" name="submit_reminder" class="button button-primary" id="popup-reminder-form-submit" disabled="disabled"><?php echo $_smarty_tpl->tpl_vars['aLang']->value['password_reminder_submit'];?>
</button></p>
				</form>
			</div>
		</div>
