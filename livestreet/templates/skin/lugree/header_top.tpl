<header id="header" role="banner">
	...
	<ul class="nav nav-main" id="nav-main">
        {if $oUserCurrent}
        <li class="create-button"><a href="{router page='topic'}add/" class="button button-write js-write-window-show" id="modal_write_show">{$aLang.block_create}</a></li>
        {/if}
	...
	{else}
		<ul class="auth">
            ...
            <li><a href="{router page='login'}" class="js-login-form-show sign-in button button-primary">{$aLang.user_login_submit}</a></li>
            <li>{$aLang.header_or}</li>
