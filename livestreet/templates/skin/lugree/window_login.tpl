			...
			<div class="tab-content js-block-popup-login-content" data-type="login">
				...
				<form action="{router page='login'}" method="post" id="popup-login-form">
					...
					<p>
                        ...
                        <input type="text" name="login" id="popup-login" placeholder="{$aLang.user_login}" class="input-text input-width-full">
                    </p>
			...
			<div data-type="reminder" class="tab-content js-block-popup-login-content" style="display:none;">
				...
				<form action="{router page='login'}reminder/" method="POST" id="popup-reminder-form">
					<p>
					    ...
					    <input type="text" name="mail" placeholder="{$aLang.password_reminder_email}" id="popup-reminder-mail" class="input-text input-width-full" />
					    <small class="validate-error-hide validate-error-reminder"></small>
                    </p>
                    <p class="submit-form clearfix">
                        <button type="submit" name="submit_reminder" class="button button-primary input-width-full" id="popup-reminder-form-submit" disabled="disabled">{$aLang.password_reminder_submit}</button>
                    </p>
				</form>
			</div>
		</div>
