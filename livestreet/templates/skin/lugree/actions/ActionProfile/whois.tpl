...
{include file='header.tpl' menu='people' usermenu='menu.profile_whois.tpl'}
...
<div class="profile-info-about">
    {include file='actions/ActionProfile/profile_header.tpl' oUserProfile=$oUserProfile oUserCurrent=$oUserCurrent}
...
<div class="wrapper">
    <div class="profile-header">
        ...
        <div class="profile-right">
            ...
            <div class="profile-contact-list-wrap">
    ...
    <div class="profile-info-cnt">
        ...
        <ul class="profile-dotted-list">
            ...
            {if $aUsersFriend}
            <li>
                <span class="user-list-title"><a href="{$oUserProfile->getUserWebPath()}friends/">{$aLang.profile_friends}</a> {$iCountFriendsUser}</span>
