...
<body class="{$body_classes} width-{cfg name='view.grid.type'}">
	...
	<div id="header-back" style="background-image: url('{cfg name="path.static.skin"}/images/bg/header-bg.jpg?t={$sHeaderTime}');"></div>
	
	<div id="container" class="{hook run='container_class'}">
		{include file='header_top.tpl'}
		{include file='nav.tpl' usermenu=$usermenu}

		<div id="wrapper" class="clearfix {if $noSidebar}no-sidebar{/if}{hook run='wrapper_class'}">
			{if !$noSidebar}
