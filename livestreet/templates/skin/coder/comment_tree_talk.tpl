...
<div class="comments" id="comments">
	<header class="comments-header">
		<h3><span id="count-comments">{$iCountComment}</span> {$iCountComment|declension:$aLang.comment_count_talk:'russian'}</h3>
...
{else}
		...
		<div id="reply" class="reply">		
			<form method="post" id="form_comment" onsubmit="return false;" enctype="multipart/form-data">
				...
				<button type="submit"  name="submit_comment" 
						...
						class="button button-primary">Ответить</button>
	...
	{else}
		Для добавления комментариев, вы должны <a href="{router page='login'}" style="text-decoration:underline">войти</a> или <a href="{router page='registration'}" style="text-decoration:underline">зарегистрироваться</a>
	{/if}
{/if}	
