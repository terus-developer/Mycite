...
return array(
	...
	'share_topic'  =>  'Поделиться',
	'blog_menu_top'  =>  'Рейтинг',
	'topic_read_more'  =>  'Читать дальше →',
    'block_search_h2' =>  'Поиск по сайту',
    'block_search_find' =>  'Найти',
    'block_tags_h2' =>  'Теги',
    'header_add' =>  'Создать топик',
    'topic_comm' =>  'Комментариев',
    'user_mail' =>  'новых письма',
    'user_mail_none' =>  'Нет новых писем',
    'in' =>  'в',
    'paging_previos' =>  'Назад',
    'paging_next' =>  'Вперед',
);