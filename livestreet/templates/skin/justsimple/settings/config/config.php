...
/* Fluid settings */
$config['view']['grid']['fluid_min_width'] = 950; // Min - 976px
$config['view']['grid']['fluid_max_width'] = 1600;
...
$config['block']['rule_index_blog'] = array(
	'blocks'  => array(
			'right' => array('stream'=>array('priority'=>100),'blogs'=>array('priority'=>50),'tags'=>array('params'=>array(),'priority'=>1))
		),
	'clear' => false,
);
